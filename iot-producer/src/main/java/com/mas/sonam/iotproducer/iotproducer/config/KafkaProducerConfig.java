...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, IotDevice> producerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs(), stringKeySerializer(), iotDeviceJsonSerializer());
    }
    ...
    @Bean
    public KafkaTemplate<String, IotDevice> iotDeviceKafkaTemplate() {
    ...
    @Bean
    public Serializer iotDeviceJsonSerializer() {
